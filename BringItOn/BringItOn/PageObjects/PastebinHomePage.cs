...
namespace ICanWin
{
    class PastebinHomePage
    {
       ...
       //Set text to pasty
        ...
        public void SetSyntaxHiglight(string syntax)
        {
            WebDriverWait wait = new WebDriverWait(driver, TimeSpan.FromSeconds(10));
            wait.Until(e => e.FindElement(By.Id("select2-postform-format-container"))).Click();
            wait.Until(e => e.FindElement(By.XPath($"//li[text()='{syntax}']"))).Click();
